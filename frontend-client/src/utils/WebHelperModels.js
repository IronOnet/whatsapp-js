...
export const getChatRoomChatModel = (chatItem, isNewChat, userId, text) =>{
    ...
    const mChatId = userType === webConstants.OWNER ? chatItem.chatId : chatItem.userId; 
    const mUserId = userType === webConstants.OWNER ? chatItem.userId: chatItem.chatId;
...
export const getChatListModel = (item, isNewChat, chatUnreadCount) =>{
    return {
        ...
        chat: {
            ...
            chatImage: item.chat[0].chatTime, 
